...
/* VCBaseBundle:Agencia:show.html.twig */
class __TwigTemplate_cc9229db51d1fbefbe7e8728c7f30a3a extends Twig_Template
{
    ...
    <li>
        <form action=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agencia_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "VCBaseBundle:Agencia:show.html.twig";
    }
