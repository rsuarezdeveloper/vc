...
\t\t\t\t\t\t\t\t<h3>";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user"), "nombre"), "html", null, true);
            echo "</h3>
\t\t\t\t\t\t\t\t<p>Ultimo ingreso:";
            // line 41
