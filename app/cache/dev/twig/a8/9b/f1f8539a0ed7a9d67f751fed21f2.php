...
/* VCBaseBundle:Aerolinea:show.html.twig */
class __TwigTemplate_a89bf1f8539a0ed7a9d67f751fed21f2 extends Twig_Template
{
    ...
    <li>
        <form action=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("aerolinea_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "VCBaseBundle:Aerolinea:show.html.twig";
    }
